...
The module requires Perl 5.10 or later.  It also requires L<B> and
...
add <https://github.com/wakaba/perl-json-ps> as a Git submodule of the
Git repository of your application.
